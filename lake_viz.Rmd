...
t_plot_5m <- ggplot(data = temp_5m, 
       aes(x = fct_reorder(lake_name, month), 
           y = temp_c, 
           group = lake_name)) + 
  geom_jitter(aes(color = lake_name),
             alpha = 0.6) +
  coord_flip() +
  theme_bw() +
  labs(y = "Temp (ºC)", x = "", color = "")
...
ggsave(here::here("figures", "5m_temp.png"), plot = t_plot_5m)
...
ggsave(here::here("figures", "daily_cycles.png"), plot = daily_cycles) 
...
ggsave(here::here("figures", "year_plot.png"), plot = year_plot)
